...
• اختصاصي حماية المجموعه من السبام والخ..
• كت تويت, مقالات , واشياء كثير .
• ارفعني مشرف و ارسل تفعيل و راح يتفعل .
↫ Dev🎖  ]]..SUDO_USER:gsub([[\_]],'_')..[[ 
]])
return false
end
