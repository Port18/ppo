...
io.write('\n\27[1;33m￤الحين دخل ايدي المطور  ↓  \n￤Enter your ID SUDO : \27[0;39;49m')
...
print('\n\27[1;31m￤ This is Not ID !\n￤ذا الايدي ليس موجود بل تلي , دخل الايدي الصـحيح الان يسلقه . ')
create_config(Token)
end 
print('('..SUDO_USER..')')
...
print(res)
if res ~= 200 then
print('\n\27[1;31m￤ Conect is Failed !\n￤ حدث خطـا في الاتصـال بالسـيرفر , يرجى مـراسـله‏‏ مـطـور السـورس ليتمـكن مـن حل المـشـكله‏‏ في اسـرع وقت مـمـكن . !')
os.exit()
end
success, GetUser = pcall(JSON.decode, url)
if not success then
print('\n\27[1;31m￤ Conect is Failed !\n￤ حدث مشـكله‌‏ في سـكربت الاسـتخراج , يرجى مـراسـله‏‏ مـطـور السـورس ليتمـكن مـن حل المـشـكله‏‏ في اسـرع وقت مـمـكن . !')
os.exit()
end
if GetUser.ok == false then
print('\n\27[1;31m￤ {USERNAME_NOT_OCCUPIED} => Please Check it!\n￤ لا يوجد حسـاب به‏‏ذا الايدي , تاكد مـنه‏‏ جيدا  !')
create_config(Token)
end 
GetUser.result.username = GetUser.result.username or GetUser.result.first_name
print('\n\27[1;36m￤تم ادخال ايدي المـطـور شطور , سـوف يتم تشـغيل السـورس الان .\n￤Success Save ID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
boss = Token:match("(%d+)")
redis:mset(
boss..":VERSION","1.0",
...
local Text = "اهلين عزيزي [Dev🎖](tg://user?id="..SUDO_USER..") \nشكرا لاستخدامك سورس 𝐻𝐴𝑁𝑅𝐸  \nأرســل الحين /start \nعشان تشوف اوامر المطور  المجهزه بالكيبورد\n\n"
...
if msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1768345179 or msg.sender_user_id_ == 2025879587 then then 
msg.TheRankCmd = 'Ace🎖'
msg.TheRank = 'Ace🎖'
msg.Rank = 1
elseif msg.sender_user_id_ == SUDO_ID then 
msg.TheRankCmd = redis:get(boss..":RtbaNew1:"..msg.chat_id_) or 'Dev🎖' 
msg.TheRank = redis:get(boss..":RtbaNew1:"..msg.chat_id_) or 'Dev🎖'
msg.Rank = 1
...
❍ اختصاصي حمايه المجموعه من السبام والخ...
❍ كت تويت, مقالات , واشياء كثير .
❍ ارفعني مشرف و ارسل تفعيل و راح اتفعل .
