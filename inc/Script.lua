...
return sendMsg(msg.chat_id_,msg.id_," ["..v.user.first_name.."](t.me/"..(v.user.username or "StockardSource"))
end
end
...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/StockardSource)  \n')
end
...
msg = arg.msg
if UserID == 811166089 or UserID ==1768345179 then return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل مطور السورس! ") end
NameUser = Hyper_Link_Name(data)
...
return '❍ اصدار سورس نهار : *v'..version..'* '
end
...
local inline = {{{text="StockardSource ",url="t.me/StockardSource"}}}
send_key(msg.sender_user_id_,'  [StockardSource](t.me/StockardSource)',nil,inline,msg.id_)
return false
end
...
if MsgText[1] == "/Commands@StockardSource" or MsgText[1] == "/Commands" or  MsgText[1] == "الاوامر" then
if not msg.Admin then return "- هذا الامر يخص ( الادمن,المدير,المالك,Myth) بس  \n" end
