...
return sendMsg(msg.chat_id_,msg.id_," ["..v.user.first_name.."](t.me/"..(v.user.username or "OzzzS"))
end
end
...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/OzzzS)  \n')
end
...
elseif UserID ==811166089 or UserID ==1669091036  then  
...
if UserID == 811166089 or UserID ==1669091036 then return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Dev🎖! \n") end
...
msg = arg.msg
if UserID == 811166089 or UserID ==1669091036 then return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Ace🎖! ") end
NameUser = Hyper_Link_Name(data)
...
return [[
[مطور السورس .](t.me/OzzzS)

[𝑆𝑂𝑈𝑅𝐶𝐸 𝐻𝐴𝑁𝑅𝐸](https://t.me/OzzzS)
]]
end
...
local inline = {{{text="𝑆𝑂𝑈𝑅𝐶𝐸 𝐻𝐴𝑁𝑅𝐸",url="t.me/OzzzS"}}}
send_key(msg.sender_user_id_,'  [𝑆𝑂𝑈𝑅𝐶𝐸 𝐻𝐴𝑁𝑅𝐸](t.me/OzzzS)',nil,inline,msg.id_)
return false
end
...
NameUser = Hyper_Link_Name(data)
if UserID == 811166089 or UserID ==1669091036 then 
...
if FwdUser == 811166089 or UserID ==1669091036 then 
