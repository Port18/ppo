...
if not msg.SudoUser then return"❍ هذا الامر يخص ( Dev🎖 ) بس  \n" end
return sudolist(msg) 
end
...
return '❍ اصدار سورس لونا : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'❍ معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس نهار يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="𝚂𝚘𝚞𝚛𝚌𝚎 𝙻𝚘𝚗𝚊 ",url="t.me/XzzzU"}}}
send_key(msg.sender_user_id_,'  [𝚂𝚘𝚞𝚛𝚌𝚎 𝙻𝚘𝚗𝚊](t.me/XzzzU)',nil,inline,msg.id_)
return false
end
...
if MsgText[1] == "/Commands@XzzzU" or MsgText[1] == "/Commands" or  MsgText[1] == "الاوامر" then
if not msg.Admin then return "- هذا الامر يخص ( الادمن,المدير,المالك,Myth) بس  \n" end
...
• ارفعه مشرف وارسل تفعيل ليتم تفعيل المجموعة .]]..SUDO_USERR..[[
