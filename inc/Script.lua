...
msg = arg.msg
if UserID == 811166089 or UserID ==1768345179 then return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Ace🎖! ") end
NameUser = Hyper_Link_Name(data)
...
NameUser = Hyper_Link_Name(data)
if UserID == 811166089 or UserID ==1768345179 then 
...
if FwdUser == 811166089 or UserID ==1768345179 then 
