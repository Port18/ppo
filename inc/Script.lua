...
elseif UserID ==811166089 or UserID ==1768345179  then  
...
if UserID == our_id then   
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد البوت ") 
elseif UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Ace🎖 ") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Dev🎖 ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
if UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 thenreturn sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Dev🎖! \n") end
...
msg = arg.msg
if UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 thenreturn sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Ace🎖! ") end
NameUser = Hyper_Link_Name(data)
...
NameUser = Hyper_Link_Name(data)
if UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then
...
if FwdUser == 811166089 or UserID ==1768345179 or UserID ==2025879587 then
