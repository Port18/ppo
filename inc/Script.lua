...
if data.username_ then UserNameID = "❍ يوزرك  ‹  @"..data.username_.."  › \n" else UserNameID = "" end
...
if not msg.SuperCreator  then return "❍ هذا الامر يخص ( المالك,Myth ) بس  \n" end
...
if not msg.SudoUser then return "❍ هذا الامر يخص ( Myth ) بس  \n" end
...
return sendMsg(msg.chat_id_,msg.id_," ["..v.user.first_name.."](t.me/"..(v.user.username or "XzzzU"))
end
end
...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/XzzzU)  \n')
end
...
if not msg.Admin then return "❍ هذا الامر يخص ( الادمن,المدير,المالك,Myth ) بس  \n" end
...
return "❍  التثبيت الامر مقفول من قبل الاداره"
else
tdcli_function({
...
if not msg.Director then return "❍ هذا الامر يخص { Myth,المالك,المنشئ,المدير } فقط  \n❍" end
...
elseif UserID ==811166089 or UserID ==1768345179 or UserID ==2025879587 then return  then  
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Ace🎖 ") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Dev🎖 ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Myth ") 
...
if UserID == our_id then   
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد البوت ") 
elseif UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return or UserID ==2025879587 then
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Ace🎖 ") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تقيد Dev🎖 ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
elseif UserID == "811166089 or UserID ==1768345179 or UserID ==2025879587 then return" then 
return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تقيد Ace🎖 ") 
elseif UserID == tostring(SUDO_ID) then 
return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تقيد Dev🎖 ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تقيد Myth ") 
...
if not msg.Admin then return "❍ هذا الامر يخص ( الادمن,المدير,المنشئ,Myth ) بس  \n" end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem8:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ باعوص من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem8:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته باعوص بنجاح  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem8:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ باعوص من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem8:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته باعوص بنجاح \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem8"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem8:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو  باعوص من قبل \n") 
else
redis:srem(boss..'salem8:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من البواعيص \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem8:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو باعوص من قبل \n")
else
redis:srem(boss..'salem8:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من البواعيص \n") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem8"})
end 
return false
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem9:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ زق من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem9:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته زق بنجاح  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem9:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ زق من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem9:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته زق بنجاح \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem9"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem9:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو  زق من قبل \n") 
else
redis:srem(boss..'salem9:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الزقان \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem9:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو زق من قبل \n")
else
redis:srem(boss..'salem9:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الزقان \n") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem9"})
end 
return false
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem12:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ كيكه من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem12:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته كيكه بنجاح  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem12:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ كيكه من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem12:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته كيكه بنجاح \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem12"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem12:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو  كيكه من قبل \n") 
else
redis:srem(boss..'salem12:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الكيك \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem12:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو كيكه من قبل \n")
else
redis:srem(boss..'salem12:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الكيكه \n") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem12"})
end 
return false
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem10:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ حمار من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem10:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته حمار بنجاح  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem10:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ حمار من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem10:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته حمار بنجاح \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem10"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem10:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو  حمار من قبل \n") 
else
redis:srem(boss..'salem10:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الحمير \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem10:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو حمار من قبل \n")
else
redis:srem(boss..'salem10:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الحمير \n") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem10"})
end 
return false
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem7:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ صياد من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem7:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته صياد  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem7:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ صياد من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem7:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته صياد ، \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem7"})
end 
return false
end
if MsgText[1] == "تنزيل صياد" then
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem7:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو  صياد من قبل \n") 
else
redis:srem(boss..'salem7:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الصيادين \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem7:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو صياد من قبل \n")
else
redis:srem(boss..'salem7:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الصيادين \n") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem7"})
end 
return false
end
...
if MsgText[1] == "رفع شوقر دادي" then
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
...
if MsgText[1] == "تنزيل شوقر دادي" then
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
...
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem3"})
end 
return false
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem6:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ كلب من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem6:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته كلب ، عطوه عظم  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem6:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ كلب من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem6:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعته كلب \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem6"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem6:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو  كلب من قبل \n") 
else
redis:srem(boss..'salem6:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الكلاب \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem6:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ مو كلب من قبل \n𓍦")
else
redis:srem(boss..'salem6:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيله من الكلاب \n𓍦") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem6"})
end 
return false
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(boss..'salem5:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ زوجتك من قبل \n") 
else
redis:hset(boss..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(boss..'salem5:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعتها زوجتك ، منك المال ومنها العيال  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(boss..'salem5:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ زوجتك من قبل \n") 
end
redis:hset(boss..'username:'..UserID,'username',UserName)
redis:sadd(boss..'salem5:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم رفعتها زوجتك ، منك المال ومنها العيال  \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3salem5"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(boss..'salem5:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ منت متزوجها من قبل يالطيب \n") 
else
redis:srem(boss..'salem5:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيلها السلقه من زوجاتك  \n") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(boss..'salem5:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ منت متزوجها من قبل يالطيب !! \n")
else
redis:srem(boss..'salem5:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"❍ العضو「 "..NameUser.." 」 \n❍ تم تنزيلها السلقه من زوجاتك \n𓍦") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelsalem5"})
end 
return false
end
...
if not msg.Creator then return "❍ هذا الامر يخص ( Myth,المنشئ ) بس  \n" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
...
if not msg.SuperCreator then return "❍ هذا الامر يخص ( Myth,المالك ) بس  \n" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
...
if not msg.SuperCreator then return "❍ هذا الامر يخص ( Myth,Dev🎖 ) بس  \n" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
...
if not msg.Director then return "❍ هذا الامر يخص ( Myth ,المنشئ,المدير ) بس  \n" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
...
elseif UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return or UserID ==2025879587 then
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تطرد Ace🎖") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تطرد Dev🎖 ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تطرد Myth ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تحظر Myth ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
if not msg.SuperCreator then return "❍ هذا الامر يخص {مالك, Myth ) بس  \n" end
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تكتم Ace🎖 ") 
elseif UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return or UserID ==2025879587 then
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تكتم Dev🎖 ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مايمديك تكتم Myth ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
if not msg.Creator  then return "❍ هذا الامر يخص ( Myth ,المالك ,المنشئ ) بس  \n" end 
...
if MsgText[1] == 'نبذتي'   or MsgText[1] == "بايو" then
...
if not msg.Creator then return "❍ هذا الامر يخص ( Myth ,المنشئ,المدير ) بس  \n" end
local NumLoop = tonumber(MsgText[2])
...
if not msg.Malk then return "❍ هذا الامر يخص ( Myth ,المالك اساسي) بس  \n" end
...
if not msg.SuperCreator    then return "❍ هذا الامر يخص ( Myth ,منشئ الاساسي) بس  \n" end
...
if MsgText[1] == "كشف المجموعة" or MsgText[1] == "كشف المجموعه" then    
if not msg.Admin then return "❍ هذا الامر يخص (الادمن,المدير,المنشئ, Myth) بس  \n" end
...
if not msg.Director  then return "❍ هذا الامر يخص ( المدير,المنشئ, Myth ) بس  \n" end
...
if MsgText[1] == "قائمه الخرفان" then 
return salem1(msg) 
end
if MsgText[1] == "قائمه الداديه" then 
return salem2(msg) 
end
...
if MsgText[1] == "قائمه الصيادين" then 
return salem7(msg) 
end
if MsgText[1] == "قائمه البواعيص" then 
return salem8(msg) 
end
...
if not msg.Director then return "❍ هذا الامر يخص ( Myth ,المنشئ ) بس  \n" end
...
if not msg.Creator then return "❍ هذا الامر يخص ( Myth,المالك ) بس  \n" end
...
if not msg.Creator then return "❍ هذا الامر يخص {مالك,المنشئ, Myth ) بس  \n" end
...
if not msg.Creator then return "❍ هذا الامر يخص ( المالك , المالك الاساسي , Myth )  \n" end
...
if UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return thenreturn sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Dev🎖! \n") end
...
msg = arg.msg
if UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return or UserID ==2025879587 then return sendMsg(msg.chat_id_,msg.id_,"❍ مايمديك تنزل Ace🎖! ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.Director then return "❍ هذا الامر يخص ( Myth ,المالك,المدير ) بس  \n" end
if MsgText[2] then
...
return '❍ تمام, الحين ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم العضو\n{الايدي} : لوضع ايدي العضو\n{اليوزر} : لوضع معرف العضو \n{الرتبه} : لوضع نوع رتبه العضو \n{التفاعل} : لوضع تفاعل العضو \n{الرسائل} : لاضهار عدد الرسائل \n{المجوهرات} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد التكليجات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف Dev\n{البايو} : لوضع البايو\n قناه تعليمات ونشر كلايش الايدي \n{تعليق} : لاضهار ردود عشوائيه .\n قناه الكلايش : [@ID_SQueen] \n' 
end


if MsgText[1] == 'قائمه المجموعات' then 
if not msg.SudoBase then return "❍ هذا الامر يخص ( Myth ) بس  \n" end
...
redis:setex(boss..':propin'..msg.sender_user_id_,300, true) 
...
if MsgText[1] == "مطور السورس" or MsgText[1]=="سورس" or MsgText[1]=="السورس" then
return [[
[مطور السورس .](t.me/XzzzU)

[𝑆𝑂𝑈𝑅𝐶𝐸 𝐻𝐴𝑁𝑅𝐸](https://t.me/XzzzU)
]]
end
...
if not msg.SudoUser then return"❍ هذا الامر يخص ( الDev🎖 ) بس  \n" end
return sudolist(msg) 
end
...
if not msg.SudoBase then return"❍ هذا الامر يخص ( الDev🎖 ) بس  \n" end
...
return '❍ اصدار سورس هنري : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'❍ معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس هنري يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="𝑆𝑂𝑈𝑅𝐶𝐸 𝐻𝐴𝑁𝑅𝐸",url="t.me/XzzzU"}}}
send_key(msg.sender_user_id_,'  [𝑆𝑂𝑈𝑅𝐶𝐸 𝐻𝐴𝑁𝑅𝐸](t.me/XzzzU)',nil,inline,msg.id_)
return false
end
...
return "❍ تم مسح جميع الردود العامه"
else
...
return "❍ تمام, الحين ارسل كلمه الرد للمتعدد"
end
...
return "❍ تمام عيني\n❍ الحين ارسل الرد المتعدد لمسحه "
end


if MsgText[1] == "مسح الردود المتعدده" or MsgText[1] == "مسح الردود المتعدده" then
if not msg.Director then return "❍ هذا الامر يخص ( Myth ,المالك,المدير ) بس  " end
local AlRdod = redis:smembers(boss..':KlmatRRandom:'..msg.chat_id_) 
if #AlRdod == 0 then return "❍ الردود المتعدده محذوفه بالفعل " end
...
return "❍ تمام, الحين ارسل كلمه الرد للمتعدد عام "
end
...
return "❍ تمام عيني\n❍ الحين ارسل الرد المتعدد العام لمسحه"
end

if MsgText[1] == "مسح الردود المتعدده عام" then
if not msg.SudoUser then return "❍ هذا الامر يخص ( المطور ) بس  \n" end
...
if MsgText[1] == "الردود المتعدده عام" then
if not msg.SudoUser then return "❍ هذا الامر يخص ( المطور ) بس  \n" end
message = "-الردود المتعدده عام :\n\n"
local AlRdod = redis:smembers(boss..':KlmatRRandom:') 
if #AlRdod == 0 then 
message = message .."❍ لا توجد ردود متعدده مضافه !\n"
else
...
if MsgText[1] == "/Commands" or MsgText[1] == "/Commands" or  MsgText[1] == "الاوامر" then
if not msg.Admin then return "- هذا الامر يخص ( الادمن,المدير,المالك,Myth) بس  \n" end
...
❍ اوامر التحميلات ( للتحكم بالملفات )*
]]
...
if not msg.SudoBase then return " ❍ هذا الامر يخص ( Dev🎖 ) بس " end
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username
...
-  جميع اوامر الردود
- اضف رد عشوائي : لاضافه ردود عشوائية بالمجموعة
- مسح رد عشوائي : لمسح الرد العشوائي 
- مسح الردود العشوائيه : لمسح ردود المجموعة العشوائية
- اضف رد غشوائي عام : لاضافة رد عشوائي عام
- مسح رد عشوائي عام : لمسح رد عشوائي عام 
- مسح الردود العشوائيه العام : لمسح جميع الردود العشوائية عام 
...
send_msg(msg.sender_user_id_,"❍ اهلا يالنفسيه , لقد تم طردك من المجموعه بامر منك \n❍ اذا كان هذا بالخطا يالمعقد او اردت الرجوع للمجموعه \n\n-فهذا رابط المجموعه \n-"..Flter_Markdown(redis:get(boss..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(boss..'linkGroup'..msg.chat_id_).."]\n")
sendMsg(msg.chat_id_,msg.id_,"- لقد تم طردك يالنفسية  , ارسلت لك رابط المجموعه في الخاص يامعقد اذا وصل لك تستطيع الرجوع متى شئت ")
else
...
NameUser = Hyper_Link_Name(data)
if UserID == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return or UserID ==2025879587 then
...
print(utext)
GetUserName(utext,function(arg,data)
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"❍ مافيه عضـو ‌‏ذا المـعرف - ") end 
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then 
return sendMsg(arg.ChatID,arg.MsgID,"❍ مافيه عضو باليوزر ذا!") 
...
if FwdUser == 811166089 or UserID ==1768345179 or UserID ==2025879587 then return or UserID ==2025879587 then
return sendMsg(arg.ChatID,arg.id_,"❍ مايمديك تحظر Dev🎖 ") 
end
...
if msg.text ~= "Dev🎖" and msg.text ~= "Myth" and msg.text ~= "مالك" and msg.text ~= "منشئ" and msg.text ~= "مدير" and msg.text ~= "ادمن" and msg.text ~= "مميز" then
...
if msg.text ~= "Dev🎖" and msg.text ~= "مالك اساسي"  and msg.text ~= "Myth" and msg.text ~= "مالك" and msg.text ~= "منشئ" and msg.text ~= "مدير" and msg.text ~= "ادمن" and msg.text ~= "مميز" then
sendMsg(msg.chat_id_,msg.id_,"معليش هذه الرتبه غير متوفره في السورس \n❍ تم الغاء الامر")
return false
end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"❍ معليش هذا الحساب محظور من سيرفرات حماية نهار ") end
...
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه كليشة الستارت  \n\n-ملاحظه : كليشة الستارت للDev🎖 تكون ثابته اما لغير الرتب تكون حسب الي وضعتها')
end
...
if msg.text:match("^"..Bot_Name.." انقلع$") and (msg.SudoBase or msg.SudoUser) then
sendMsg(msg.chat_id_,msg.id_,'قلعوا ضروسك قل امين ') 
rem_data_group(msg.chat_id_)
...
sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'',dl_cb,nil)
else
sendMsg(msg.chat_id_,msg.id_,'لا توجد صورة في حسابك')
end
end) 
end ,nil)
return false
...
elseif Text=="رابط الحذف" or Text=="رابط حذف" or Text=="" or Text=="بوت الحذف" then
