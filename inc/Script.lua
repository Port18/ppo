...
return sendMsg(msg.chat_id_,msg.id_," ["..v.user.first_name.."](t.me/"..(v.user.username or "C888i"))
end
end
...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/C888i)  \n')
end
...
if not msg.SuperCreator then return "• هذا الامر يخص ( Myth,مطور الاساسي ) بس  \n" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
...
if UserID == 811166089 or UserID ==1669091036 then return sendMsg(msg.chat_id_,msg.id_,"• مايمديك تنزل مطور الاساسي! \n") end
...
msg = arg.msg
if UserID == 811166089 or UserID ==1669091036 then return sendMsg(msg.chat_id_,msg.id_,"• مايمديك تنزل مطور السورس! ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.SudoUser then return"• هذا الامر يخص ( المطور الاساسي ) بس  \n" end
return sudolist(msg) 
end
...
local inline = {{{text="C888i ",url="t.me/C888i"}}}
send_key(msg.sender_user_id_,'  [C888i](t.me/C888i)',nil,inline,msg.id_)
return false
end
...
if MsgText[1] == "/Commands@C888i" or MsgText[1] == "/Commands" or  MsgText[1] == "الاوامر" then
if not msg.Admin then return "- هذا الامر يخص ( الادمن,المدير,المالك,Myth) بس  \n" end
...
if msg.text ~= "مطور الاساسي" and msg.text ~= "Myth" and msg.text ~= "مالك" and msg.text ~= "منشئ" and msg.text ~= "مدير" and msg.text ~= "ادمن" and msg.text ~= "مميز" then
...
if msg.text ~= "مطور الاساسي" and msg.text ~= "مالك اساسي"  and msg.text ~= "Myth" and msg.text ~= "مالك" and msg.text ~= "منشئ" and msg.text ~= "مدير" and msg.text ~= "ادمن" and msg.text ~= "مميز" then
sendMsg(msg.chat_id_,msg.id_,"معليش هذه الرتبه غير متوفره في السورس \n• تم الغاء الامر")
return false
end
