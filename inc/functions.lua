...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"لاتبعص لابعصك",true) end
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"لا تبعص لابعصك",true) end
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"لا تبعص",true) end
msg.textmsg = [[اهلا بك عزيزي في اوامر البوت
...
..'[{"text": " التـالي ","callback_data": "List2"}],'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التـالي ","callback_data": "List3"},'..'{"text": " الـسـابـق ","callback_data": "List1"}],'
..'[{"text": "» رجوع ","callback_data": "CmdBack"},{"text": "❍ اخفاء الامر","callback_data": "LoginOut"}]'
..']}'
msg.KeyboardCmd = list_settings
textMD = [[
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التـالي ","callback_data": "List4"},'..'{"text": " الـسـابـق ","callback_data": "List2"}],'
..'[{"text": "» رجوع ","callback_data": "CmdBack"},{"text": "❍ اخفاء الامر","callback_data": "LoginOut"}]'
..']}'
msg.KeyboardCmd = list_settings
textMD = [[
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التـالي ","callback_data": "CmdSudo"},'..'{"text": " الـسـابـق ","callback_data": "List3"}],'
..'[{"text": "» رجوع ","callback_data": "CmdBack"},{"text": "❍ اخفاء الامر","callback_data": "LoginOut"}]'
..']}'
msg.KeyboardCmd = list_settings
textMD = [[
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التـالي ","callback_data": "CmdFiles"},'..'{"text": " الـسـابـق ","callback_data": "List4"}],'
..'[{"text": "» رجوع ","callback_data": "CmdBack"},{"text": "- اخفاء الامر","callback_data": "LoginOut"}]'
..']}'
msg.KeyboardCmd = list_settings
...
list_settings = '{"inline_keyboard": ['
..'[{"text": "التـالي ","callback_data": "List3"},'..'{"text": " الـسابـق ","callback_data": "List1"}],'
...
list_settings = list_settings:gsub('false', '{✔︎ }')
msg.KeyboardCmd = list_settings
msg.textmsg = " - اهلا بك عزيزي في لستة الاوامر\n ✔︎ - الان يمكنك قفل وفتح \nالاعدادات عبر الازرار\n✔︎ - تعني مفتوح او مسموح\n✘ - تعني مقفول او ممنوع"
msg.Editeinline = true
return SendMsgInline(msg)
end
...
function RandomText()
local Cominnt = {
'- سَهيت بنظرة عيِونك واثاري هالعيون بلادَ.🤍',
"- بس بس يكفي حلاوة",
"- ‏وأطيل النظر إلى صورتك لكي أحيا🤍",
"اطلق ايدي",
"- مُتعة للناظرين مُش ايدي",
"- وهه وهه جبر",
"- دزز بسس",
"- سلكو له قولو له جبر عشان ينبسط",
"- كم تدفع و اقول جبر",
"- يع لا تكتب ايدي مره ثانيه",
"- صراحه ايديك يجيب الهمّ",
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1768345179 then 
Adminn = true
...
download_file('https://gitlab.com/Port18/ppo.git/-/raw/main/inc/Run.lua ','./inc/Run.lua') 
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end 
download_file('https://gitlab.com/Port18/ppo.git/-/raw/main/inc/locks.lua','./inc/locks.lua') 
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end 
download_file('https://gitlab.com/Port18/ppo.git/-/raw/main/inc/Script.lua','./inc/Script.lua') 
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end 
download_file('https://gitlab.com/Port18/ppo.git/-/raw/main/inc/functions.lua','./inc/functions.lua') 
download_file('https://gitlab.com/Port18/ppo.git/-/raw/main/plugins/games.lua','./plugins/games.lua') 
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "𝐻𝐴𝑁𝑅𝐸"
...
usernn = data.username_ or "C888i"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "C888i"
end
Name = Name:gsub('[[][]]','')
...
result = false
if msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1768345179 or msg.sender_user_id_ == 2025879587  then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 811166089 or UserID ==1768345179or UserID ==2025879587 then 
var = 'Ace🎖'
...
var = redis:get(boss..":RtbaNew3:"..ChatID) or ' المالك اساسي' 
...
var = redis:get(boss..":RtbaNew4:"..ChatID) or 'المنشئ' 
...
message = message ..i.. '-l ['..info.username..'](t.me/C888i) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/C888i) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/C888i) l » (`' ..v.. '`) \n'
end
end
end
...
return "- اشترك بالقناة اولا ["..UserChaneel.."] \n- ثم ارجع ارسل تفعيل ."
end
end
...
if cmd == "tqeed" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيدني ياسلقه") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيد Dev🎖") 
elseif UserID == 811166089 or UserID ==1768345179or UserID ==2025879587 then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيد Ace🎖") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيد Myth") 
elseif redis:sismember(boss..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيد المنشى") 
elseif redis:sismember(boss..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيد المالك الاساسي") 
elseif redis:sismember(boss..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تقيد المالك")
elseif redis:sismember(boss..'owners:'..ChatID,UserID) then 
...
if cmd == "ban" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"❍ هيه صاحي انت تبي تحظرني ؟") 
elseif UserID == 811166089 or UserID ==1768345179or UserID ==2025879587 then 
return sendMsg(ChatID,MsgID,"❍ مايمديكك تحظر Ace🎖") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تحظر Dev🎖") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تحظر Myth") 
elseif redis:sismember(boss..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تحظر المنشى") 
elseif redis:sismember(boss..':MONSHA_Group:'..ChatID,UserID) then 
...
if cmd == "kick" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"❍ مايمديك يالعبد تطردني ") 
elseif UserID == 811166089 or UserID ==1768345179or UserID ==2025879587 then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تطرد Ace🎖") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تطرد Dev🎖") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تطرد Myth") 
elseif redis:sismember(boss..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تطرد المنشى") 
elseif redis:sismember(boss..':MONSHA_Group:'..ChatID,UserID) then 
...
if cmd == "ktm" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"❍ مالقيت إلا انا تكتمني") 
elseif UserID == 811166089 or UserID ==1768345179or UserID ==2025879587 then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تكتم Ace🎖") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تكتم Dev🎖") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID," لا يمكنك كتم Myth ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ مايمديك تكتم المنشى") 
elseif redis:sismember(boss..':MONSHA_Group:'..ChatID,UserID) then 
...
return sendMsg(ChatID,MsgID," الهطف  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد حظره عام  من المجموعات ✓") 
end
redis:hset(boss..'username:'..UserID, 'username', Resolv)
...
if UserID == our_id then return sendMsg(ChatID,MsgID,"❍ مالقيت الا انا تنزلني !") end
if UserID == 811166089 or UserID ==1768345179or UserID ==2025879587 then return sendMsg(ChatID,MsgID,"❍ مايمديك تنزل Ace🎖 ! ") end
...
if redis:sismember(boss..':MONSHA_Group:'..ChatID,UserID) then 
DonisDown = DonisDown.."❍  تم تنزيله من المالك الاساسي ✓️\n"
end 
if redis:sismember(boss..':Malk_Group:'..ChatID,UserID) then 
...
function senddwon()  sendMsg(ChatID,MsgID,"❍ ماتقدر تنزل رتبة أعلى منك ") end
