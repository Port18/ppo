...
result = false
if msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1768345179 then 
SudoBase = true
...
if UserID == 811166089 or UserID ==1768345179 then return sendMsg(ChatID,MsgID,"❍ مايمديك تنزل Ace🎖 ! ") end
