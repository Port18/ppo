...
elseif UserID == 811166089 or UserID ==1669091036 then 
return sendMsg(ChatID,MsgID,"❍ مايمديكك تحظر مطور السورس") 
elseif UserID == SUDO_ID then 
...
if UserID == 811166089 or UserID ==1669091036 then return sendMsg(ChatID,MsgID,"❍ مايمديك تنزل مطور السورس ! ") end
