...
if not msg.Creator then return "❍ هذا الامر يخص ( Myth,المالك ) بس  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.SuperCreator then return "❍ هذا الامر يخص ( المالك الاساسي,Myth ) بس  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.Director  then return "❍ هذا الامر يخص ( المدير,المالك,Myth ) بس  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.Admin then return "❍ هذا الامر يخص ( الادمن,المدير,المالك,Myth ) بس  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.Creator   then return "❍ هذا الامر يخص ( المالك,Myth ) بس  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
redis:mset(
