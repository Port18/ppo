...
return "- هذا الامر يخص (المالك,Myth) بس" 
end 
...
sendMsg(msg.chat_id_,msg.id_,'*❍ ارسل لي عدد النقاط اللي تبيها*')
end
...
return '* ❍عدد النقاط اللي جمعتها هي ( '..points..' )\n ❍ يمديك تبيع نقاطك وتاخذ (100) رساله مقابل كل جوهره من النقاط *\n'
else
...
return '❍ ماعندك نقاط بذا العدد عشان ابيعهم!' 
end
if points == "0" then
...
redis:incrby(boss..':User_Points:'..msg.chat_id_..data.id_,5)
sendMsg(msg.chat_id_,msg.id_,'*❍ كفو فزت معنا وخمنت الرقم صح تم اضفت لك ( 5 ) نقاط\n *\n')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
